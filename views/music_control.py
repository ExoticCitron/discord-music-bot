...
class MusicControl(View):
    ...
    async def skip(self, interaction: discord.Interaction, button: Button):
        ...
        print(f"User {interaction.user.name} is trying to skip a song.")
        ...
        if vc and vc.is_playing():
            ...
            # fixed: removed the incorrect second parameter
            await music_cog.play_next_song(interaction.guild.id)
    ...
    async def disconnect(self, interaction: discord.Interaction, button: Button):
        ...
        if vc and vc.is_connected():
            ...
            disconnxion.set_footer(text="https://divisionbot.space/")
